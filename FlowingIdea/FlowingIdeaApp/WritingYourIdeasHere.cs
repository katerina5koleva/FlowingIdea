...
public partial class WritingYourIdeasHere : Form
{
    ...
    public WritingYourIdeasHere(int userId)
    {
        InitializeComponent();
        UpdateGrid();
        this.userId = userId;
    ...
    private Idea GetEditedIdea(Idea redactedIdea)
    {
        redactedIdea.textOfIdea = txtIdea.Text;
        return redactedIdea;
    }
    ...
    private void addArtisticButton_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool) 
        {
            ...
            ArtisticIdea artisticIdea = new()
            {
                IdeaType = 1,
                UserId = userId,
                TextOfArtisticIdea = newIdeaText
            };
            artisticIdea.TextOfArtisticIdea = newIdeaText;
            ideaBusinessLogic.AddNewArtisticIdea(newIdeaText, userId);
    ...
    private void addWorkIdea_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool)
        {
            ...
            WorkIdea workIdea = new()
            {
                IdeaType = 3,
                UserId = userId,
                TextOfWorkIdea = newIdeaText
            };
            workIdea.TextOfWorkIdea = newIdeaText;
            ideaBusinessLogic.AddNewWorkIdea(newIdeaText, userId);
    ...
    private void addPhilosophicalIdea_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool)
        {
            ...
            PhilosophicalIdea philosophicalIdea = new ()
            {
                IdeaType = 2,
                UserId = userId,
                TextOfPhilosophicalIdea = newIdeaText
            };
            philosophicalIdea.TextOfPhilosophicalIdea = newIdeaText;
            ideaBusinessLogic.AddNewPhilosophicalIdea(newIdeaText, userId);
    ...
    {
        //Idea editedIdea = GetEditedIdea(Idea redacted);
    ...
    {
        dataGridView1.DataSource = ideaBusinessLogic.GetAllPhilosophical(userId);
        dataGridView1.ReadOnly = true;
        dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        UpdateGrid();
    }
    ...
    {
        dataGridView1.DataSource = ideaBusinessLogic.GetAllArtistic(userId);
        dataGridView1.ReadOnly = true;
        dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        UpdateGrid();
    ...
    private void workIdeaCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        dataGridView1.DataSource = ideaBusinessLogic.GetAllWork(userId);
        dataGridView1.ReadOnly = true;
        dataGridView1.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        UpdateGrid();
    }
