...
public partial class WritingYourIdeasHere : Form
{
    ...
    private void addArtisticButton_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool) 
        {
            ...
            ArtisticIdea artisticIdea = new ArtisticIdea(userId, newIdeaText);
    ...
    private void addWorkIdea_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool)
        {
            ...
            WorkIdea workIdea = new WorkIdea(userId, newIdeaText);
    ...
    private void addPhilosophicalIdea_Click(object sender, EventArgs e)
    {
        ...
        else if (addBool)
        {
            ...
            PhilosophicalIdea philosophicalIdea = new PhilosophicalIdea(userId, newIdeaText);
