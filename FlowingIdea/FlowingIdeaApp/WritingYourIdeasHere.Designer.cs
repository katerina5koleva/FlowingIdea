namespace FlowingIdeas.Presentation
{
	partial class WritingYourIdeasHere
	{
		...
		private void InitializeComponent()
		{
			...
			PhilosophicalCheckBox = new CheckBox();
			...
			// 
			// PhilosophicalCheckBox
			// 
			PhilosophicalCheckBox.AutoSize = true;
			PhilosophicalCheckBox.Font = new Font("Rockwell", 10.2F, FontStyle.Bold, GraphicsUnit.Point);
			PhilosophicalCheckBox.ForeColor = Color.Brown;
			PhilosophicalCheckBox.Location = new Point(23, 24);
			PhilosophicalCheckBox.Name = "PhilosophicalCheckBox";
			PhilosophicalCheckBox.Size = new Size(198, 24);
			PhilosophicalCheckBox.TabIndex = 1;
			PhilosophicalCheckBox.Text = "Philosophical ideas";
			PhilosophicalCheckBox.UseVisualStyleBackColor = true;
			// 
			...
			Controls.Add(PhilosophicalCheckBox);
		...
		private CheckBox PhilosophicalCheckBox;
